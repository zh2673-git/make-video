...
// 分镜 type ↔ 组件一一对应（漏型 TS 编译报错）
const COMPONENTS: Record<SceneType, React.FC<{scene: Scene; meta: ProjectMeta}>> = {
  title: TitleScene,
  ending: EndingScene,
...
const SceneView: React.FC<{scene: Scene; meta: ProjectMeta}> = ({scene, meta}) => {

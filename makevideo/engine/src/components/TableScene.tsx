...
export const TableScene: React.FC<{scene: Scene; meta: ProjectMeta}> = ({scene, meta}) => {
  ...
  return (
    <Shell scene={scene} meta={meta}>
      <div style={{display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'center', gap: dense ? 14 : 26}}>
        <table
          style={{
